...
<html>
	...
	<section class="main-section client-part" style="color=#fff;" id="sukces">
	    <div class="container">
	        <b class="user wow fadeInDown delay-03"><i class="fa-check"></i></b>
	        <div class="row">
	            <div class="col-lg-12">
	                <p class="client-part-haead wow fadeInDown delay-05">${client.getName()} brawo ! Pomyślnie zamówiłeś
	                    sesje, do zobaczenia na planie ${form.date} ! <br>

	...
	<section class="main-section" id="konto">
	    <div class="container ">
	        ...
	        <p class="client-part-haead wow fadeInDown delay-05 caption"
	           style="color: black; text-align: center;">${employee.getName()}, zlecenia które realizujesz:</p>
	        <br/> <br/>
	        <br>
	        <br>
	        <h3 style="text-align: center;" class="wow animated fadeInDown delay-07s">Sesje:</h3>
	        ...
	        <br><br>
	       <h3 style="text-align: center;" class="center-block wow animated fadeInDown delay-07s">Obróbki zdjęć:</h3>       
	        <div class="bootstrap-iso text-center ">
	            <div class="col-lg-12 wow animated fadeInDown delay-09s">
	                <table class="table table-hover table-hovered" style="text-align: center;">
	                    <thead>

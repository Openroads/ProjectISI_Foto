...
<body>
	...
	<section class="main-section client-part" id="rejestracja">
		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-12">
					<p class="client-part-haead wow fadeInDown delay-05">Dołącz
						do nas i ciesz się nieziemską jakością!</p>
				</div>
			</div>
			<div id=zalogujHandler></div>
	...
	<section class="main-section team" id="zaloguj">
		...
		<div class="container">
			...
			<div class="col-lg-4 col-lg-offset-4 wow fadeInLeft delay-01s"
				...
				<form:form action="login" modelAttribute="loginForm" method="post">
					<c:if test="${pageContext.request.method=='GET'}">
						...
						<form:input path="login" id="login" type="email"
							...
							onblur="if(this.value=='')this.value=this.defaultValue;"></form:input>
					...
					<c:if test="${pageContext.request.method=='POST'}">
						<form:input path="login" id="login" type="email"
							cssStyle="width: 100%; text-align: center;" cssClass="input-text"></form:input>
						<form:errors path="login" cssStyle="color: #ff0000;" />
						<spring:bind path="login">
							<c:if test="${status.error}">
								<br />Nie masz jeszcze konta ?
                    				<a href="${contextPath}/register">Zarejestruj
									się</a>
							</c:if>
						...
						<form:input path="password" id="pwd" type="password"
							cssStyle="width: 100%; text-align: center;" cssClass="input-text"></form:input>
						<span style="color: #ff0000;"><form:errors path="password" />
						</span>
						<br />
		...
		<section class="main-section contact" id="kontakt">
			...
			<div class="team-leader-block clearfix">
				...
				<div class="team-leader-box">
					...
					<span class="wow fadeInDown delay-09s">Programmer</span>
					<p class="wow fadeInDown delay-09s">Spec od Windowsa, zna całą
						platformę. Od jakiegoś czasu zastanawiamy się skąd w naszym
						projekcie zamiast normalnych błędów zaczęły się pojawiać blue
						screeny...</p>
				</div>
			</div>
			<br /> <br />

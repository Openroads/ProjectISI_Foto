...
<html>
	        ...
	        <ul class="main-nav">
	            <li class="dropdown"><a href="#" data-toggle="dropdown">Oferta <span class="caret"></span></a>
	                <ul class="dropdown-menu">
	                    ...
	                    <li><a href="${contextPath}/opinion">Wystawianie opinii</a></li>
	                </ul>
	            </li>
	                ...
	                <div class="service-list">
	                    ...
	                    <div class="service-list-col2">
	                        <p class="client-part-haead wow fadeInDown delay-05 caption"
	                           style="color : black;">${client.getName()}</p>
	                        <p class="client-part-haead wow fadeInDown delay-05 caption"
	                           style="color : black;">${client.getSurname()}</p>
	                    </div>
	                </div>
	                <div class="service-list">
	                    <div class="service-list-col1">
	                    ...
	                    <div class="service-list-col2">
	                        <p class="client-part-haead wow fadeInDown delay-05"
	                           style="color : black;">${client.getAddress()}</p>
	                    </div>
	                </div>
	                <div class="service-list">
	                    <div class="service-list-col1">
	                    ...
	                    <div class="service-list-col2">
	                        <p class="client-part-haead wow fadeInDown delay-05"
	                           style="color : black;">${client.getIdentityNumber()}</p>
	                    </div>
	                </div>
	                <div class="service-list">
	                    <div class="service-list-col1">
	                    ...
	                    <div class="service-list-col2">
	                       <p class="client-part-haead wow fadeInDown delay-05"
	                           style="color : black;">${client.getPhoneNumber()}</p>
	                    </div>
	                </div>
	                <div class="service-list">
	                    <div class="service-list-col1">
	                    ...
	                    <div class="service-list-col2">
	                        <p class="client-part-haead wow fadeInDown delay-05 caption"
	                           style="color : black;">${client.getEmail()}</p>
	                    </div>
	                </div>
	            </div>
	        </div>
	...
	<!--main-section-end-->
	<!--client-part-start-->
	<section class="main-section client-part" id="edytuj">
	    <div class="container">
	        ...
	        <div class="row">
	            <div class="col-lg-4 col-sm-6 wow fadeInLeft delay-05s">
	                <div class="service-list">
	                    ...
	                    <div class="service-list-col2">
	                        <a href="${contextPath}/photos"><h3>OBRÓBKA &amp; WYWOŁANIE</h3></a>
	                ...
	                <div class="service-list">
	                    ...
	                    <div class="service-list-col2">
	                        ...
	                        <p>Do państwa dyspozycji oddajemy także najlepszej klasy grafików, którzy nie pozwolą aby
	                            Państwa zdjęciom stała się krzywda.</p>
	                    </div>
	                </div>
	            </div>
	            <figure class="col-lg-8 col-sm-6  text-right wow fadeInUp delay-02s">
